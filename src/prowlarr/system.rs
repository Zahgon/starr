...
use crate::req::{Request, multipart_form_file, path_join};
...
pub struct SystemStatus {
    ...
    #[serde(default)]
    pub branch: String,
    /// When the running build was compiled.
    #[serde(default)]
    ...
    #[serde(default)]
    pub is_debug: bool,
    /// Whether the app runs in Docker.
    #[serde(default)]
    pub is_docker: bool,
    ...
    #[serde(default)]
    pub is_mono: bool,
    /// Whether the app runs on .NET Core.
    #[serde(default)]
    ...
    /// How the package updates itself.
    #[serde(default)]
...
impl Prowlarr {
    ...
    /// Returns all available Prowlarr backup files.
    ///
