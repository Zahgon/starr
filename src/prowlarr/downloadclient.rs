...
const BP_DOWNLOAD_CLIENT: &str = "v1/downloadClient";
...
pub struct DownloadClientInput {
    ...
    #[serde(default)]
    pub priority: i32,
    /// Download client ID. Leave zero when creating.
    #[serde(default, skip_serializing_if = "is_default")]
    pub id: i64,
    /// Configuration contract name.
    #[serde(default)]
    pub config_contract: String,
    /// Implementation type of the download client.
    #[serde(default)]
    pub implementation: String,
    /// Download client name.
    #[serde(default)]
    pub name: String,
    /// Protocol the client downloads with.
    #[serde(default)]
    pub protocol: Protocol,
    /// Tags applied to this download client.
    #[serde(default)]
    pub tags: Vec<i32>,
...
impl Prowlarr {
    ...
    pub async fn get_download_client(&self, client_id: i64) -> Result<DownloadClientOutput> {
        self.api
    ...
    pub async fn delete_download_client(&self, client_id: i64) -> Result<()> {
        self.api
