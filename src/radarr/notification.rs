...
pub struct NotificationInput {
    ...
    #[serde(default, skip_serializing_if = "is_default")]
    pub on_rename: bool,
    /// Notify when a movie is added.
    #[serde(default, skip_serializing_if = "is_default")]
    pub on_movie_added: bool,
    /// Notify when a movie is deleted.
    #[serde(default, skip_serializing_if = "is_default")]
    pub on_movie_delete: bool,
    /// Notify when a movie file is deleted.
    #[serde(default, skip_serializing_if = "is_default")]
    pub on_movie_file_delete: bool,
    /// Notify when a movie file is deleted for an upgrade.
    #[serde(default, skip_serializing_if = "is_default")]
...
pub struct NotificationOutput {
    ...
    /// Whether the implementation supports movie added events.
    #[serde(default)]
    pub supports_on_movie_added: bool,
    /// Whether the implementation supports movie delete events.
    ///
    /// The upstream API spells this key with a capital `S`.
    #[serde(default, rename = "SupportsOnMovieDelete")]
    pub supports_on_movie_delete: bool,
    /// Whether the implementation supports movie file delete events.
    #[serde(default)]
    pub supports_on_movie_file_delete: bool,
    /// Whether the implementation supports movie file delete for upgrade events.
    #[serde(default)]
