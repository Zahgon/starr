...
pub struct MediaManagement {
    ...
    /// Whether movie folders are renamed automatically.
    #[serde(default, skip_serializing_if = "is_default")]
    pub auto_rename_folders: bool,
    /// Whether previously downloaded movies are unmonitored.
    #[serde(default, skip_serializing_if = "is_default")]
    ...
    /// Whether empty movie folders are created.
    #[serde(default, skip_serializing_if = "is_default")]
    ...
    /// Whether paths default to static.
    #[serde(default, skip_serializing_if = "is_default")]
