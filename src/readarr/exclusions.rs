...
pub struct Exclusion {
    /// MusicBrainz ID of the excluded author.
    #[serde(default)]
    pub foreign_id: String,
    /// Name of the excluded author.
    #[serde(default)]
...
impl Readarr {
    ...
    /// Removes exclusions from Readarr.
    ///
