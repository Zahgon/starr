...
const BP_BLOCKLIST: &str = "v1/blocklist";
...
impl Readarr {
    ...
    ///
    /// If you need control over the page, use [`Readarr::get_block_list_page`].
    pub async fn get_block_list(&self, records: i32) -> Result<BlockList> {
        ...
        loop {
            ...
            if collected >= curr.total_records || (collected >= records && records != 0) || curr_len == 0
            {
