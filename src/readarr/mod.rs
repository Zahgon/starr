//! The SDK client for the Readarr API.
...
/// The Readarr API version supported by this library.
pub const APIVER: &str = "v1";

/// Contains all the methods to interact with a Readarr server.
#[derive(Debug, Clone)]
pub struct Readarr {
...
impl Readarr {
    /// Returns a Readarr object used to interact with the Readarr API.
    ...
    /// Returns a Readarr object backed by any [`ApiClient`] implementation.
...
/// All history events.
pub const FILTER_ALL: Filtering = Filtering(0);
/// Release was grabbed.
pub const FILTER_GRABBED: Filtering = Filtering(1);
/// Book file was imported.
pub const FILTER_BOOK_FILE_IMPORTED: Filtering = Filtering(3);
/// Download failed.
