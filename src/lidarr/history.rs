...
pub struct HistoryRecord {
    ...
    #[serde(default)]
    pub id: i64,
    /// Album the event applies to.
    #[serde(default)]
    pub album_id: i64,
    /// Artist the event applies to.
    #[serde(default)]
    pub artist_id: i64,
    /// Track the event applies to.
    #[serde(default)]
    pub track_id: i64,
...
impl Lidarr {
    /// Returns the Lidarr History (grabs/failures/completed).
    ///
    /// If you need control over the page, use [`Lidarr::get_history_page`].
    ...
    /// Returns a single page from the Lidarr History (grabs/failures/completed).
    ///
