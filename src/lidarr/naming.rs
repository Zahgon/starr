...
pub struct Naming {
    ...
    #[serde(default)]
    pub id: i64,
    /// Format used for standard tracks.
    #[serde(default)]
    pub standard_track_format: String,
    /// Format used for multi-disc tracks.
    #[serde(default)]
    pub multi_disc_track_format: String,
    /// Format used for artist folders.
    #[serde(default)]
